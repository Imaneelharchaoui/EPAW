...
<div class="container" style="margin-top:30px;">
		...
		<div class="row">
			<div class="col-12 text-center " >
				<p id="text1">Veuilez choisir une action </p>
			</div>
		</div>
			
		<div class="row">
			<div class="col-12 text-center " >
			  <a href="<%=request.getContextPath() %>/Admin"><button type="button" class="btn btn-outline-dark btn-lg">Gestion adherents</button></a>
			</div>
		</div>
		
		<div class="row ">
			<div class="col-12 text-center" style="margin-top:20px;" >
				<a href="<%=request.getContextPath()%>/Reclamation"><button type="button" class="btn btn-outline-dark btn-lg">Voir Reclamations</button></a>
			</div>

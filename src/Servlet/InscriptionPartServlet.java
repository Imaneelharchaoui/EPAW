...
public class InscriptionPartServlet	 extends HttpServlet {
    private InscriptionPartDAO particulierDao;

    public void init() {
        particulierDao = new InscriptionPartDAO();
    }
    ...
    throws ServletException, IOException {
        ...
        boolean bool = false;
        try {
           bool = particulierDao.findparticulier(email);
    ...
    if (erreurs.isEmpty() && bool==true) {
        ...
        try {
            ...
            result = particulierDao.ajoutparticulier(particulier);
           if (result !=0) {

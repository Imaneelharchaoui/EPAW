...
public class ReclamationAssocDAO {

    public int ajoutreclamation(Reclamation reclamation) throws ClassNotFoundException {
        String INSERT_USERS_SQL = "INSERT INTO reclamationassoc" +
        ...
        try (Connection connection = DriverManager
            ...
            preparedStatement.setString(2, reclamation.getObjet());
            preparedStatement.setString(3, reclamation.getMessage());

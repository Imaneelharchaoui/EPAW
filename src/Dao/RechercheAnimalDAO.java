...
public class RechercheAnimalDAO {

    public ArrayList<Animal> getAnimal(String espece) throws ClassNotFoundException {
        String query = "SELECT * FROM annonces WHERE espece ='"+espece+"'"; 
